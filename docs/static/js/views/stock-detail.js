...
const StockDetailView = {
  ...
  _renderHeader(quote) {
    ...
    header.innerHTML = `
      ...
      <div class="stock-header-actions">
        <button class="ai-analyze-btn" id="ai-btn">
        ...
        <button class="stock-buy-btn" id="stock-buy-btn">
    ...
    header.querySelector('#stock-buy-btn').onclick = () => {
      App.openBuyModal(this._ticker, quote.name, quote.current_price, quote.currency);
    };
    return header;
  },
  ...
  async _runAiAnalysis() {
    ...
    if (btn) { btn.disabled = true; btn.innerHTML = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2a4 4 0 0 0-4 4v2H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2h-2V6a4 4 0 0 0-4-4z"/></svg> 분석 중...'; }
